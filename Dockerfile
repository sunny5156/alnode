FROM hub.docker.thinkchanges.cn/suntek/msf-alpine:1.0.2
#FROM alpine:3.9
...
ENV VERSION=v10.16.3 NPM_VERSION=10 YARN_VERSION=latest
#ENV VERSION=v12.9.1 NPM_VERSION=10 YARN_VERSION=latest

# For base builds
# ENV CONFIG_FLAGS="--fully-static --without-npm" DEL_PKGS="libstdc++" RM_DIRS=/usr/include

RUN apk add --no-cache curl make gcc g++ python linux-headers binutils-gold gnupg libstdc++ zip \
